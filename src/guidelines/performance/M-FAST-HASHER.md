...
When hashing trusted, internal keys, prefer a fast non-cryptographic hasher (e.g., `FxHash`) over the standard library default. 
...
// Good, uses faster fxhash for internal keys.
let lookup = HashMap::<UserID, Data, FxBuildHasher>::with_capacity(1024);
```
