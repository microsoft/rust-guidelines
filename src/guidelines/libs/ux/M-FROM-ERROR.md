...
- TODO: Clarify the policy for canonical error structs (cf. M-ERRORS-CANONICAL-STRUCTS) — each source error gets at most one `From` impl per target.
...
- TODO: Note interaction with M-ERRORS-CANONICAL-STRUCTS and M-APP-ERROR.
