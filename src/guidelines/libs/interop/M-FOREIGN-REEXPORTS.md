...
When a crate accepts or returns a type defined in some third-party crate, users are be expected to depend on that third-party crate directly and import the type from there. That said, there are a few valid exceptions to this rule:
